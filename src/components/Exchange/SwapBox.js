...
export default function SwapBox(props) {
  ...
  const renderErrorModal = () => {
    ...
    if (chainId === AVALANCHE) {
      ...
      externalSwapUrl = `https://app.uniswap.org/#/swap?chain=rinkeby&inputCurrency=${inputCurrency}&outputCurrency=${outputCurrency}`;
    } else {
  ...
  const swap = async () => {
    ...
    contract = new ethers.Contract(routerAddress, chainId === RINKEBY ? RouterVR.abi : Router.abi, library.getSigner());
