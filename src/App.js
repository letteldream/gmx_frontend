...
const bscWsProvider = new ethers.providers.JsonRpcProvider("https://bsc-dataseed1.binance.org");
const bscTestWsProvider = new ethers.providers.JsonRpcProvider("https://data-seed-prebsc-1-s1.binance.org:8545");

const rinkebyWsProvider = new ethers.providers.JsonRpcProvider("https://rpc.ankr.com/eth_rinkeby");
...
const FullApp = () => {
  ...
  useEffect(() => {
    const wsVaultAbi = chainId === ARBITRUM ? VaultV2.abi : chainId === RINKEBY ? VaultVR.abi : VaultV2b.abi;
    ...
    const wsPositionRouter = new ethers.Contract(
      ...
      chainId === RINKEBY ? PositionRouterVR.abi : PositionRouter.abi,
      wsProvider
    );
