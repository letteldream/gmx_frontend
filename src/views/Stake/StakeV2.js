...
import VaultVR from "../../abis/VaultVR.json";
import Vault from "../../abis/Vault.json";
import ReaderVR from "../../abis/ReaderVR.json";
import ReaderV2 from "../../abis/ReaderV2.json";
import VesterVR from "../../abis/VesterVR.json";
import Vester from "../../abis/Vester.json";
import RewardRouterVR from "../../abis/RewardRouterVR.json";
import RewardRouter from "../../abis/RewardRouter.json";
import RewardReaderVR from "../../abis/RewardReaderVR.json";
import RewardReader from "../../abis/RewardReader.json";
import Token from "../../abis/Token.json";
import GlpManagerVR from "../../abis/GlpManagerVR.json";
...
function StakeModal(props) {
  ...
  const onClickPrimary = () => {
    ...
    const contract = new ethers.Contract(
      rewardRouterAddress,
      chainId === RINKEBY ? RewardRouterVR.abi : RewardRouter.abi,
      library.getSigner()
    );
...
function VesterDepositModal(props) {
  ...
  const onClickPrimary = () => {
    ...
    const contract = new ethers.Contract(
      vesterAddress,
      chainId === RINKEBY ? VesterVR.abi : Vester.abi,
      library.getSigner()
    );
...
export default function StakeV2({ setPendingTxns, connectWallet }) {
  ...
  const { data: walletBalances } = useSWR(
    ...
    {
      fetcher: fetcher(library, chainId === RINKEBY ? ReaderVR : ReaderV2, [walletTokens]),
    }
  );
  ...
  const { data: depositBalances } = useSWR(
    ...
    {
      fetcher: fetcher(library, chainId === RINKEBY ? RewardReaderVR : RewardReader, [
        depositTokens,
  ...
  const { data: stakingInfo } = useSWR(
    ...
    {
      fetcher: fetcher(library, chainId === RINKEBY ? RewardReaderVR : RewardReader, [rewardTrackersForStakingInfo]),
    }
  );
  ...
  const { data: aums } = useSWR([`StakeV2:getAums:${active}`, chainId, glpManagerAddress, "getAums"], {
    fetcher: fetcher(library, chainId === RINKEBY ? GlpManagerVR : GlpManager),
  });

  const { data: nativeTokenPrice } = useSWR(
    [`StakeV2:nativeTokenPrice:${active}`, chainId, vaultAddress, "getMinPrice", nativeTokenAddress],
    {
      fetcher: fetcher(library, chainId === RINKEBY ? VaultVR : Vault),
    }
  );
  ...
  const { data: esGmxSupply } = useSWR(
    ...
    {
      fetcher: fetcher(library, chainId === RINKEBY ? ReaderVR : ReaderV2, [excludedEsGmxAccounts]),
    }
  );
  ...
  const { data: vestingInfo } = useSWR(
    ...
    {
      fetcher: fetcher(library, chainId === RINKEBY ? ReaderVR : ReaderV2, [vesterAddresses]),
    }
  );
    ...
    <div className="default-container page-layout">
      ...
      <div className="StakeV2-content">
        <div className="StakeV2-cards">
          <div className="App-card StakeV2-gmx-card">
            <div className="App-card-title">DIV</div>
            ...
            <div className="App-card-content">
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatKeyAmount(processedData, "gmxBalance", 18, 2, true)} DIV ($
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatKeyAmount(processedData, "gmxInStakedGmx", 18, 2, true)} DIV ($
                    ...
                    renderContent={() => {
                      return (
                        <>
                          ...
                          <div className="Tooltip-row">
                            <span className="label">Escrowed DIV</span>
                            <span>
                ...
                <div>
                  ...
                  {totalGmxStaked && (
                    <Tooltip
                      ...
                      renderContent={() => (
                        <>
                          Arbitrum: {formatAmount(arbitrumGmxStaked, 18, 0, true)} DIV
                          <br />
                          Avalanche: {formatAmount(avaxGmxStaked, 18, 0, true)} DIV
                        </>
                      )}
                    />
                  )}
              ...
              <div className="App-card-row">
                ...
                {totalGmxSupply && (
                  <div>
                    {formatAmount(totalGmxSupply, 18, 0, true)} DIV ($
          ...
          <div className="App-card primary StakeV2-total-rewards-card">
            ...
            <div className="App-card-content">
              ...
              <div className="App-card-row">
                <div className="label">Escrowed DIV</div>
                <div>
          ...
          <div className="App-card">
            <div className="App-card-title">DAT ({chainName})</div>
            <div className="App-card-divider"></div>
            <div className="App-card-content">
              <div className="App-card-row">
                <div className="label">Price</div>
              ...
              <div className="App-card-row">
                <div className="label">Wallet</div>
                <div>
                  {formatKeyAmount(processedData, "glpBalance", GLP_DECIMALS, 2, true)} DAT ($
      ...
      <div>
        <div className="Tab-title-section">
          ...
          <div className="Page-description">
            Convert esDIV tokens to DIV tokens.
            <br />
            Please read the{" "}
        ...
        <div>
          <div className="StakeV2-cards">
            <div className="App-card StakeV2-gmx-card">
              <div className="App-card-title">DIV Vault</div>
              <div className="App-card-divider"></div>
              <div className="App-card-content">
                <div className="App-card-row">
                  ...
                  <div>
                    <Tooltip
                      ...
                      renderContent={() => {
                        return (
                          <>
                            {formatAmount(processedData.gmxInStakedGmx, 18, 2, true)} DIV
                            <br />
                            {formatAmount(processedData.esGmxInStakedGmx, 18, 2, true)} esDIV
                            <br />
                      ...
                      renderContent={() => {
                        return (
                          <>
                            ...
                            to GMX from the&nbsp;
                            {formatKeyAmount(vestingData, "gmxVesterVestedAmount", 18, 4, true)} esDIV deposited for
                            vesting.
                          </>
                        );
                      }}
                ...
                <div className="App-card-row">
                  ...
                  <div>
                    <Tooltip
                      handle={`${formatKeyAmount(vestingData, "gmxVesterClaimable", 18, 4, true)} DIV`}
                      position="right-bottom"
                      renderContent={() =>
                        `${formatKeyAmount(
                          vestingData,
            ...
            <div className="App-card StakeV2-gmx-card">
              <div className="App-card-title">DAT Vault</div>
              <div className="App-card-divider"></div>
              <div className="App-card-content">
                <div className="App-card-row">
                  <div className="label">Staked Tokens</div>
                  <div>{formatAmount(processedData.glpBalance, 18, 2, true)} DAT</div>
                </div>
                <div className="App-card-row">
                  <div className="label">Reserved for Vesting</div>
                  <div>
                      ...
                      renderContent={() => {
                        return (
                          <>
                            ...
                            to DIV from the&nbsp;
                            {formatKeyAmount(vestingData, "glpVesterVestedAmount", 18, 4, true)} esDIV deposited for
                            vesting.
                          </>
                        );
                      }}
                ...
                <div className="App-card-row">
                  ...
                  <div>
                    <Tooltip
                      handle={`${formatKeyAmount(vestingData, "glpVesterClaimable", 18, 4, true)} DIV`}
                      position="right-bottom"
                      renderContent={() =>
                        `${formatKeyAmount(
                          vestingData,
