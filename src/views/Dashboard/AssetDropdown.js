...
import bscscanIcon from "../../img/ic_bscscan_16.svg";
import etherscanIcon from "../../img/ic_etherscan_16.svg";
...
function AssetDropdown({ assetSymbol, assetInfo }) {
  ...
  let { coingecko, arbitrum, avalanche, binance, rinkeby } = ICONLINKS[chainId][assetSymbol];
      ...
      <Menu.Items as="div" className="asset-menu-items">
        ...
        <Menu.Item>
          <>
            ...
            {binance && (
              <a target="_blank" rel="noopener noreferrer" href={binance} className="asset-item">
                <img src={bscscanIcon} alt="Open in explorer" />
                <p>Open in Explorer</p>
              </a>
            )}
            {rinkeby && (
              <a target="_blank" rel="noopener noreferrer" href={rinkeby} className="asset-item">
                <img src={etherscanIcon} alt="Open in explorer" />
                <p>Open in Explorer</p>
              </a>
            )}
          </>
