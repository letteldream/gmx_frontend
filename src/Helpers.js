...
import OrderBookReaderVR from "./abis/OrderBookReaderVR.json";
import OrderBookReader from "./abis/OrderBookReader.json";
import OrderBookVR from "./abis/OrderBookVR.json";
...
const RINKEBY_RPC_PROVIDERS = ["https://rpc.ankr.com/eth_rinkeby"];
...
export const ICONLINKS = {
  ...
  56: {
    GMX: {
      coingecko: "https://www.coingecko.com/en/coins/gmx",
      binance: "https://bscscan.com/address/0x4E408D1a61577c61570Cc41628380F42097E9F94",
    },
    GLP: {
      binance: "https://bscscan.com/address/0xdA15F5A4A99649518Eb338929eb0706789594A30",
    },
    BNB: {
      coingecko: "https://www.coingecko.com/en/coins/bnb",
    },
    ETH: {
      coingecko: "https://www.coingecko.com/en/coins/ethereum",
      binance: "https://bscscan.com/address/0x84a1Cc30eaB8Bc66D89e43cf410299Ce3F97463B",
    },
    BTC: {
      coingecko: "https://www.coingecko.com/en/coins/wrapped-bitcoin",
      binance: "https://bscscan.com/address/0xb59b161b832Fc071e6F383ab8F247e029e74a1e7",
    },
    USDC: {
      coingecko: "https://www.coingecko.com/en/coins/usd-coin",
      binance: "https://bscscan.com/address/0x9b5bb7F5BE680843Bcd3B54D4E5C6eE889c124Df",
    },
    USDT: {
      coingecko: "https://www.coingecko.com/en/coins/tether",
      binance: "https://bscscan.com/address/0x648D3d969760FDabc71ea9d59c020AD899237b32",
    },
    BUSD: {
      coingecko: "https://www.coingecko.com/en/coins/binance-usd",
      binance: "https://bscscan.com/address/0xe9e7cea3dedca5984780bafc599bd69add087d56",
    },
  },
  97: {
    GMX: {
      coingecko: "https://www.coingecko.com/en/coins/gmx",
      binance: "https://testnet.bscscan.com/address/0x4E408D1a61577c61570Cc41628380F42097E9F94",
    },
    GLP: {
      binance: "https://testnet.bscscan.com/address/0xdA15F5A4A99649518Eb338929eb0706789594A30",
    },
    BNB: {
      coingecko: "https://www.coingecko.com/en/coins/bnb",
    },
    ETH: {
      coingecko: "https://www.coingecko.com/en/coins/ethereum",
      binance: "https://testnet.bscscan.com/address/0x84a1Cc30eaB8Bc66D89e43cf410299Ce3F97463B",
    },
    BTC: {
      coingecko: "https://www.coingecko.com/en/coins/wrapped-bitcoin",
      binance: "https://testnet.bscscan.com/address/0xb59b161b832Fc071e6F383ab8F247e029e74a1e7",
    },
    USDC: {
      coingecko: "https://www.coingecko.com/en/coins/usd-coin",
      binance: "https://testnet.bscscan.com/address/0x9b5bb7F5BE680843Bcd3B54D4E5C6eE889c124Df",
    },
    USDT: {
      coingecko: "https://www.coingecko.com/en/coins/tether",
      binance: "https://testnet.bscscan.com/address/0x648D3d969760FDabc71ea9d59c020AD899237b32",
    },
    BUSD: {
      coingecko: "https://www.coingecko.com/en/coins/binance-usd",
      binance: "https://testnet.bscscan.com/address/0x14e616f71850813A937b4B1C1E358B2e7b61991D",
    },
  },
  42161: {
    GMX: {
...
export const platformTokens = {
  4: {
    GMX: {
      ...
      symbol: "GMX",
      decimals: 18,
      address: getContract(RINKEBY, "GMX"),
    ...
    GLP: {
      ...
      symbol: "GLP",
      decimals: 18,
      address: getContract(RINKEBY, "StakedGlpTracker"), // address of fsGLP token because user only holds fsGLP
...
const supportedChainIds = [ARBITRUM, AVALANCHE, TESTNET, MAINNET, RINKEBY];
...
const getWalletConnectConnector = () => {
  ...
  return new WalletConnectConnector({
    rpc: {
      ...
      [MAINNET]: BSC_RPC_PROVIDERS[0],
      [TESTNET]: BSCTESTNET_RPC_PROVIDERS[0],
      [RINKEBY]: RINKEBY_RPC_PROVIDERS[0],
    },
    qrcode: true,
    chainId,
  });
...
export const BSCTESTNET_RPC_PROVIDERS = ["https://data-seed-prebsc-1-s1.binance.org:8545"];

const RPC_PROVIDERS = {
  [MAINNET]: BSC_RPC_PROVIDERS,
  [TESTNET]: BSCTESTNET_RPC_PROVIDERS,
  [ARBITRUM]: ARBITRUM_RPC_PROVIDERS,
  [AVALANCHE]: AVALANCHE_RPC_PROVIDERS,
  [RINKEBY]: RINKEBY_RPC_PROVIDERS,
};
  ...
  const {
    ...
    fetcher: async (active, chainId, orderBookAddress, account) => {
      ...
      const orderBookContract = new ethers.Contract(
        orderBookAddress,
        chainId === RINKEBY ? OrderBookVR.abi : OrderBook.abi,
        provider
      );
      const orderBookReaderContract = new ethers.Contract(
        orderBookReaderAddress,
        chainId === RINKEBY ? OrderBookReaderVR.abi : OrderBookReader.abi,
        provider
      );
...
const NETWORK_METADATA = {
  ...
  [RINKEBY]: {
    chainId: "0x" + RINKEBY.toString(16),
    chainName: "Rinkeby",
    nativeCurrency: {
      name: "ETH",
      symbol: "ETH",
    ...
    rpcUrls: RINKEBY_RPC_PROVIDERS,
    blockExplorerUrls: [getExplorerUrl(RINKEBY)],
  },
  [AVALANCHE]: {
